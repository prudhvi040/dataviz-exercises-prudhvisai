...
st.caption('BBD squiggle: from the market summary and neighbourhood story to a demand view')
...
fig = px.scatter(plot_df, x='reviews_per_month', y='price', color='highlight',
                 ...
                 category_orders={'highlight': ['Other room types', room]},  # focus drawn on top
                 opacity=0.65,
                 labels={'reviews_per_month': 'Reviews per Month (demand proxy)',
                         'price': 'Nightly Price (£)', 'highlight': ''},
                 title=f'{room} listings keep earning reviews across the price range')
